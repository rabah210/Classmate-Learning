   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <!-- <p>your profession <span style="color:red">*</span></p>
         ...
         <div class="col">
            ...
            <p  style="margin-left:-39rem">select pic <span style="color:red">*</span></p>
            <input type="file" name="image" accept="image/*" required class="box" id="img"  style="margin-left:-39rem">
         </div>
      </div>
      <p class="link">already have an account? <a href="login.php">login now</a></p>
      <input type="submit" name="submit" value="register now" class="btn" style="color: white;background-color:#8e44ad;">
   </form>
