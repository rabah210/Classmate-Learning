...
<section class="watch-video">
   ...
   <?php
         ...
         echo '<p class="empty" style="color:red">no videos added yet!</p>';
      }
   ?>
...
<section class="comments" style="margin: 0;margin-left:-2.2rem;margin-bottom:18rem">
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn" style="border: #8e44ad solid 2px;">edit comment</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');" style="color:red;background-color:transparent;border:solid 2px #8e44ad;">delete comment</button>
         </form>
         <?php
         }
         ?>
