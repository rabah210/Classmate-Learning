...
<section class="form-container" style="min-height: calc(100vh - 19rem);margin-top:8rem">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <p style="margin-top:-10.5rem">update pic :</p>
      <input type="file" name="image" accept="image/*"  class="box" style="width:37.1rem;height:5.2rem" id="im">
      <input type="submit" name="submit" value="update now" class="btn" style="background-color:#8e44ad;color:white">
   </form>
