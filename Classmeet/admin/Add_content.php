...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <p>video status <span style="color:red">*</span></p>
      <select name="status" class="box" required>
         <option value="" selected disabled>-- select status</option>
         <option value="active">active</option>
         <option value="deactive">deactive</option>
      </select>
      <p>video title <span style="color:red">*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="enter video title" class="box">
      <p>video description <span style="color:red">*</span></p>
      <textarea name="description" class="box" required placeholder="write description" maxlength="1000" cols="30" rows="10"></textarea>
      <p>video playlist <span style="color:red">*</span></p>
      ...
      <p>select thumbnail <span style="color:red">*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box">
      <p>select video <span style="color:red">*</span></p>
      <input type="file" name="video" accept="video/*" required class="box">
      <input type="submit" value="upload video" name="submit" class="btn" style="background-color: #8e44ad;color:white;">
   </form>
