...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="thumb" accept="image/*" class="box" id="im">
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
      <p>update video</p>
      <input type="file" name="video" accept="video/*" class="box" id="im">
      <input type="submit" value="update content" name="update" class="btn" style="background-color: #8e44ad;color:white" >
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn" style="border: #8e44ad solid 2px;color:#8e44ad">view content</a>
         <input type="submit" value="delete content" name="delete_video" class="delete-btn" style="border: #8e44ad solid 2px;color:red">
      </div>
   </form>
   <?php
         }
