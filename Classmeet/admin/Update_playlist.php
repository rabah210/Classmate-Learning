...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>playlist thumbnail <span style="color: red;"></span></p>
      <div class="thumb">
         <span><?= $total_videos; ?></span>
         <img src="../uploaded_files/<?= $fetch_playlist['thumb']; ?>" alt="">
      </div>
      <input type="file" name="image" accept="image/*" class="box" id="im">
      <input type="submit" value="update playlist" name="submit" class="btn" style="background-color:#8e44ad;color:white;">
      <div class="flex-btn">
          <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn" style="border: #8e44ad solid 2px;color:#8e44ad">view playlist</a>
