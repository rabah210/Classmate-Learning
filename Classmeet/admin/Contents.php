...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn" style="background-color: #8e44ad;color:white">view content</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty" style="color:red">no contents added yet!</p>';
      }
   ?>
