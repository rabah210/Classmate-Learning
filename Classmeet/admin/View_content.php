   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video" style="border: #8e44ad solid 2px;color:red">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty" style="color:red">no contents added yet! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');" style="border:#8e44ad solid 2px;color:red">delete comment</button>
         </form>
      </div>
      <?php
       }
