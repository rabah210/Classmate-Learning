...
<section class="teachers" style="margin:-1.6rem">
   ...
   <div class="box-container">
      ...
      <?php
               ...
               echo '<p class="empty" style="color:red">no results found!</p>';
            }
         }else{
            echo '<p class="empty" style="color:red">please search something!</p>';
         }
      ?>
