...
<section class="playlist" style="margin: 0;">
   ...
   <div class="row">
      ...
      <?php
            ...
            echo '<p class="empty" style="color:red">this playlist was not found!</p>';
         }  
      ?>
...
<section class="videos-container" style="margin: 0;margin-bottom:15rem">
